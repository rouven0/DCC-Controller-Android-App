...
public class ScreenFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreateView:"+screenRatio);
        ...
        if ("16:9".equals(screenRatio)) {layoutParams.setMargins(42, 0, 42, 0);}
        else {
    ...
    private void placeSections(View view, float[][] positionArray, int[] idArray, final ToggleButton[] toggleButtonArray){
        for(int i=0; i<idArray.length; i++) {
